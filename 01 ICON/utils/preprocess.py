...
# Default to config.yml in ../config/ folder unless a different file is passed
_SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
_CONFIG_FILE = sys.argv[1] if len(sys.argv) > 1 else os.path.join(_SCRIPT_DIR, "..", "config", "config.yml")
